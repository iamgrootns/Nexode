...
const docs = `### Overview
Loads Nexode typography assets and mono nerd fonts.
...
export const Basic = {
  render: () => (
    <div style={{ display: "grid", gap: "8px" }}>
      <mod.Font />
      <div style={{ "font-family": "var(--font-family-sans)" }}>Nexode Sans Sample</div>
      <div style={{ "font-family": "var(--font-family-mono)" }}>Nexode Mono Sample</div>
    </div>
  ),
}
