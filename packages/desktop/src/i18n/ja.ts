export const dict = {
  ...
  "desktop.updater.none.message": "すでに最新バージョンの Nexode を使用しています",
  ...
  "desktop.updater.downloaded.prompt":
    "Nexode のバージョン {{version}} がダウンロードされました。インストールして再起動しますか？",
  ...
  "desktop.cli.installed.message":
    "CLI を {{path}} にインストールしました\n\nターミナルを再起動して 'nexode' コマンドを使用してください。",
  ...
  "desktop.menu.help.documentation": "Nexode ドキュメント",
  ...
  "desktop.cli.error.sidecarMissing":
    "Nexode CLI のバイナリが見つかりません。デスクトップアプリを再インストールしてみてください。",
