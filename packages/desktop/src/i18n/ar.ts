export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من Nexode",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من Nexode، هل ترغب في تثبيته وإعادة تشغيله؟",
  ...
  "desktop.menu.help.documentation": "وثائق Nexode",
  ...
  "desktop.cli.error.sidecarMissing": "ملف Nexode CLI الثنائي مفقود. حاول إعادة تثبيت تطبيق سطح المكتب.",
