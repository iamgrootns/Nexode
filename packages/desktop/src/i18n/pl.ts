export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji Nexode",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} Nexode. Czy chcesz ją zainstalować i uruchomić ponownie?",
  ...
  "desktop.cli.installed.message":
    "CLI zainstalowane w {{path}}\n\nUruchom ponownie terminal, aby użyć polecenia 'nexode'.",
  ...
  "desktop.menu.help.documentation": "Dokumentacja Nexode",
  ...
  "desktop.cli.error.sidecarMissing":
    "Brakuje pliku binarnego Nexode CLI. Spróbuj ponownie zainstalować aplikację na komputer.",
