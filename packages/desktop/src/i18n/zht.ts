export const dict = {
  ...
  "desktop.updater.none.message": "你已在使用最新版的 Nexode",
  ...
  "desktop.menu.help.documentation": "Nexode 文件",
  ...
  "desktop.cli.error.sidecarMissing": "Nexode CLI 執行檔遺失。請嘗試重新安裝桌面應用程式。",
