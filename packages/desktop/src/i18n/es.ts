export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Nexode",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Nexode. ¿Quieres instalarla y reiniciar?",
  ...
  "desktop.menu.help.documentation": "Documentación de Nexode",
  ...
  "desktop.cli.error.sidecarMissing":
    "Falta el binario de la CLI de Nexode. Intenta reinstalar la aplicación de escritorio.",
