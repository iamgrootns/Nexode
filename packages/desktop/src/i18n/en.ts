export const dict = {
  ...
  "desktop.menu.help.documentation": "Nexode Documentation",
  ...
  "desktop.updater.none.message": "You are already using the latest version of Nexode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of Nexode has been downloaded, would you like to install it and relaunch?",
  ...
  "desktop.cli.installed.message": "CLI installed to {{path}}\n\nRestart your terminal to use the 'nexode' command.",
  ...
  "desktop.cli.error.sidecarMissing": "Nexode CLI binary is missing. Try reinstalling the desktop app.",
