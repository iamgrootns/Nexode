export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'Nexode",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'Nexode a été téléchargée. Voulez-vous l'installer et redémarrer ?",
  ...
  "desktop.cli.installed.message":
    "CLI installée dans {{path}}\n\nRedémarrez votre terminal pour utiliser la commande 'nexode'.",
  ...
  "desktop.menu.help.documentation": "Documentation d'Nexode",
  ...
  "desktop.cli.error.sidecarMissing":
    "Le binaire de la CLI Nexode est manquant. Essayez de réinstaller l'application de bureau.",
