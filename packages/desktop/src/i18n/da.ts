export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af Nexode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af Nexode er blevet downloadet. Vil du installere den og genstarte?",
  ...
  "desktop.cli.installed.message":
    "CLI installeret i {{path}}\n\nGenstart din terminal for at bruge 'nexode'-kommandoen.",
  ...
  "desktop.cli.error.sidecarMissing": "Nexode CLI-binærfil mangler. Prøv at geninstallere desktop-appen.",
