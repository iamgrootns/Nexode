export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju Nexode-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} Nexode-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
  ...
  "desktop.cli.installed.message":
    "CLI je instaliran u {{path}}\n\nRestartuj terminal da bi koristio komandu 'nexode'.",
  ...
  "desktop.menu.help.documentation": "Nexode Dokumentacija",
  ...
  "desktop.cli.error.sidecarMissing":
    "Nedostaje binarna datoteka Nexode CLI-a. Pokušaj ponovo instalirati desktop aplikaciju.",
