export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do Nexode",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do Nexode foi baixada. Você gostaria de instalá-la e reiniciar?",
  ...
  "desktop.menu.help.documentation": "Documentação do Nexode",
  ...
  "desktop.cli.error.sidecarMissing":
    "O binário da CLI do Nexode está ausente. Tente reinstalar o aplicativo de desktop.",
