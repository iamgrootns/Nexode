export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av Nexode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av Nexode er lastet ned. Vil du installere den og starte på nytt?",
  ...
  "desktop.menu.help.documentation": "Nexode Dokumentasjon",
  ...
  "desktop.cli.error.sidecarMissing": "Nexode CLI-binærfil mangler. Prøv å installere skrivebordsappen på nytt.",
