export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von Nexode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von Nexode wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
  ...
  "desktop.cli.installed.message":
    "CLI wurde in {{path}} installiert\n\nStarten Sie Ihr Terminal neu, um den Befehl 'nexode' zu verwenden.",
  ...
  "desktop.menu.help.documentation": "Nexode-Dokumentation",
  ...
  "desktop.cli.error.sidecarMissing":
    "Das Nexode CLI-Binary fehlt. Versuchen Sie, die Desktop-App neu zu installieren.",
