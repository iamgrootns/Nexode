export const dict = {
  ...
  "desktop.updater.none.message": "Вы уже используете последнюю версию Nexode",
  ...
  "desktop.updater.downloaded.prompt": "Версия Nexode {{version}} загружена. Хотите установить и перезапустить?",
  ...
  "desktop.cli.installed.message":
    "CLI установлен в {{path}}\n\nПерезапустите терминал, чтобы использовать команду 'nexode'.",
  ...
  "desktop.menu.help.documentation": "Документация Nexode",
  ...
  "desktop.cli.error.sidecarMissing":
    "Отсутствует бинарный файл Nexode CLI. Попробуйте переустановить настольное приложение.",
