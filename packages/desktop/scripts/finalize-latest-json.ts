...
const releaseId = process.env.NEXODE_RELEASE
if (!releaseId) throw new Error("NEXODE_RELEASE is required")

const version = process.env.NEXODE_VERSION
if (!releaseId) throw new Error("NEXODE_VERSION is required")
...
const targets = [
  { key: "linux-x86_64-deb", asset: "nexode-desktop-linux-amd64.deb" },
  { key: "linux-x86_64-rpm", asset: "nexode-desktop-linux-x86_64.rpm" },
  { key: "linux-aarch64-deb", asset: "nexode-desktop-linux-arm64.deb" },
  { key: "linux-aarch64-rpm", asset: "nexode-desktop-linux-aarch64.rpm" },
  { key: "windows-x86_64-nsis", asset: "nexode-desktop-windows-x64.exe" },
  { key: "darwin-x86_64-app", asset: "nexode-desktop-darwin-x64.app.tar.gz" },
  {
    key: "darwin-aarch64-app",
    asset: "nexode-desktop-darwin-aarch64.app.tar.gz",
  },
]
