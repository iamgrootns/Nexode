...
beforeAll(async () => {
  ...
  mock.module("@nexode-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@nexode-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@nexode-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@nexode-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
