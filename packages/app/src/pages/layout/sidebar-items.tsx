...
import { Avatar } from "@nexode-ai/ui/avatar"
import { DiffChanges } from "@nexode-ai/ui/diff-changes"
import { HoverCard } from "@nexode-ai/ui/hover-card"
...
import { Tooltip } from "@nexode-ai/ui/tooltip"
import { getFilename } from "@nexode-ai/util/path"
import { type Message, type Session, type TextPart, type UserMessage } from "@nexode-ai/sdk/v2/client"
import { For, Match, Show, Switch, createMemo, onCleanup, type Accessor, type JSX } from "solid-js"
import { agentColor } from "@/utils/agent"
import { hasProjectPermissions } from "./helpers"
import { sessionPermissionRequest } from "../session/composer/session-request-tree"

const NEXODE_PROJECT_ID = "4b0ea68d7af9a6031a7ffda7ad66e0cb83315750"
    ...
    <div class={`relative size-8 shrink-0 rounded ${props.class ?? ""}`}>
      <div class="size-full rounded overflow-clip">
        <Avatar
          fallback={name()}
          src={
            props.project.id === NEXODE_PROJECT_ID ? "https://nexode.ai/favicon.svg" : props.project.icon?.override
          }
