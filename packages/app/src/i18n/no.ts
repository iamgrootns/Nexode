...
export const dict = {
  ...
  "dialog.provider.nexode.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.nexode.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.nexodeGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Nexode",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Nexode.",
  ...
  "provider.connect.nexodeZen.line1":
    "Nexode Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  "provider.connect.nexodeZen.line2":
    "Med én enkelt API-nøkkel får du tilgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.nexodeZen.visit.prefix": "Besøk ",
  "provider.connect.nexodeZen.visit.link": "nexode.ai/zen",
  "provider.connect.nexodeZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Nexode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Nexode.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i nexode.json",
  ...
  "dialog.server.description": "Bytt hvilken Nexode-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Nexode ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Nexode-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (nexode.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Nexode ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Nexode inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Nexode-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Nexode",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Nexode ser ut på enheten din",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Nexode er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Nexode starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Nexode.",
