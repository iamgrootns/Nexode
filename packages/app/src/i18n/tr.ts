...
export const dict = {
  ...
  "dialog.provider.nexode.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.nexode.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.nexodeGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "Nexode tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Nexode'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.nexodeZen.line1":
    "Nexode Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.nexodeZen.visit.prefix": "",
  "provider.connect.nexodeZen.visit.link": "nexode.ai/zen",
  "provider.connect.nexodeZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve Nexode'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Nexode'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler nexode.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Nexode sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "Nexode'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Nexode ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (nexode.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: Nexode henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Nexode ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Nexode Masaüstü",
  ...
  "settings.desktop.wsl.description": "Nexode sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Nexode'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "Nexode'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Nexode'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Nexode başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Nexode'un en son sürümünü kullanıyorsunuz.",
