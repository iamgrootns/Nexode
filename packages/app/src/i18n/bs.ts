export const dict = {
  ...
  "dialog.provider.nexode.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.nexode.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.nexodeGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Nexode",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Nexode-u.",
  ...
  "provider.connect.nexodeZen.line1":
    "Nexode Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  "provider.connect.nexodeZen.line2":
    "Sa jednim API ključem dobijaš pristup modelima kao što su Claude, GPT, Gemini, GLM i drugi.",
  "provider.connect.nexodeZen.visit.prefix": "Posjeti ",
  "provider.connect.nexodeZen.visit.link": "nexode.ai/zen",
  "provider.connect.nexodeZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Nexode-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Nexode-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u nexode.json",
  ...
  "dialog.server.description": "Promijeni na koji se Nexode server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija Nexode-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Nexode timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (nexode.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Nexode još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Nexode uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Nexode server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Nexode-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako Nexode izgleda na tvom uređaju",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Nexode-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Nexode pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Nexode-a.",
