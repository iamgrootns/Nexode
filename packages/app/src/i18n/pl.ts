export const dict = {
  ...
  "dialog.provider.nexode.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.nexode.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.nexodeGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Nexode",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Nexode.",
  ...
  "provider.connect.nexodeZen.line1":
    "Nexode Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  "provider.connect.nexodeZen.line2":
    "Z jednym kluczem API uzyskasz dostęp do modeli takich jak Claude, GPT, Gemini, GLM i więcej.",
  "provider.connect.nexodeZen.visit.prefix": "Odwiedź ",
  "provider.connect.nexodeZen.visit.link": "nexode.ai/zen",
  "provider.connect.nexodeZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Nexode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Nexode.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w nexode.json",
  ...
  "dialog.server.description": "Przełącz serwer Nexode, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja Nexode ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Nexode",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (nexode.json) nazwy dostawców/modeli",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Nexode does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Nexode zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Run the Nexode server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Nexode",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd Nexode na swoim urządzeniu",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Nexode.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Nexode",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Nexode.",
