...
import desktopAppIcon from "../../asset/lander/nexode-desktop-icon.png"
      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://nexode.ai/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>nexode.ai/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g nexode-ai")}>
                <code>
                  npm i -g <strong>nexode-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g nexode-ai")}>
                <code>
                  bun add -g <strong>nexode-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/nexode")}>
                <code>
                  brew install <strong>anomalyco/tap/nexode</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S nexode")}>
                <code>
                  paru -S <strong>nexode</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask nexode-desktop")}>
                <code>
                  brew install --cask <strong>nexode-desktop</strong>
                </code>
                <CopyStatus />
              </button>
