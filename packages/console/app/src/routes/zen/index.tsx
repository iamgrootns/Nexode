...
import compareVideo from "../../asset/lander/nexode-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/nexode-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="nexode:auth" content={loggedin() ? "true" : "false"} />
