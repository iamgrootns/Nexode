...
import { and, Database, eq, isNull, lt, or, sql } from "@nexode-ai/console-core/drizzle/index.js"
import { KeyTable } from "@nexode-ai/console-core/schema/key.sql.js"
import { BillingTable, LiteTable, SubscriptionTable, UsageTable } from "@nexode-ai/console-core/schema/billing.sql.js"
import { centsToMicroCents } from "@nexode-ai/console-core/util/price.js"
import { getMonthlyBounds, getWeekBounds } from "@nexode-ai/console-core/util/date.js"
import { Identifier } from "@nexode-ai/console-core/identifier.js"
import { Billing } from "@nexode-ai/console-core/billing.js"
import { Actor } from "@nexode-ai/console-core/actor.js"
import { WorkspaceTable } from "@nexode-ai/console-core/schema/workspace.sql.js"
import { ZenData } from "@nexode-ai/console-core/model.js"
import { Subscription } from "@nexode-ai/console-core/subscription.js"
import { BlackData } from "@nexode-ai/console-core/black.js"
import { UserTable } from "@nexode-ai/console-core/schema/user.sql.js"
import { ModelTable } from "@nexode-ai/console-core/schema/model.sql.js"
import { ProviderTable } from "@nexode-ai/console-core/schema/provider.sql.js"
...
import { LiteData } from "@nexode-ai/console-core/lite.js"
import { Resource } from "@nexode-ai/console-resource"
...
export async function handler(
  ...
  const ADMIN_WORKSPACES = [
    ...
    "wrk_01K6W1A3VE0KMNVSCQT43BG2SX", // nexode bench
  ]
  ...
  try {
    ...
    const sessionId = input.request.headers.get("x-nexode-session") ?? ""
    const requestId = input.request.headers.get("x-nexode-request") ?? ""
    const projectId = input.request.headers.get("x-nexode-project") ?? ""
    const ocClient = input.request.headers.get("x-nexode-client") ?? ""
    logger.metric({
      is_tream: isStream,
      session: sessionId,
      request: requestId,
    ...
    const retriableRequest = async (retry: RetryOptions = { excludeProviders: [], retryCount: 0 }) => {
      ...
      const res = await fetchWith429Retry(reqUrl, {
        ...
        headers: (() => {
          ...
          headers.delete("x-nexode-request")
          headers.delete("x-nexode-session")
          headers.delete("x-nexode-project")
          headers.delete("x-nexode-client")
          return headers
        })(),
        body: reqBody,
      })
  ...
  function validateBilling(authInfo: AuthInfo, modelInfo: ModelInfo): BillingSource {
    ...
    const billingUrl = `https://nexode.ai/workspace/${authInfo.workspaceID}/billing`
    const membersUrl = `https://nexode.ai/workspace/${authInfo.workspaceID}/members`
