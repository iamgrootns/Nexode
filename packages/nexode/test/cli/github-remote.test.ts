...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/iamgrootns/Nexode.git")).toEqual({ owner: "sst", repo: "nexode" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/iamgrootns/Nexode")).toEqual({ owner: "sst", repo: "nexode" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:iamgrootns/Nexode.git")).toEqual({ owner: "sst", repo: "nexode" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:iamgrootns/Nexode")).toEqual({ owner: "sst", repo: "nexode" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/iamgrootns/Nexode.git")).toEqual({ owner: "sst", repo: "nexode" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/iamgrootns/Nexode")).toEqual({ owner: "sst", repo: "nexode" })
})
