...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders NEXODE_CALLER", () => {
    process.env["NEXODE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode NEXODE_CALLER", () => {
    process.env["NEXODE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown NEXODE_CALLER", () => {
    process.env["NEXODE_CALLER"] = "unknown"
