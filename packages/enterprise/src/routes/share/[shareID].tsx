import { FileDiff, Message, Model, Part, Session, SessionStatus, UserMessage } from "@nexode-ai/sdk/v2"
import { SessionTurn } from "@nexode-ai/ui/session-turn"
import { SessionReview } from "@nexode-ai/ui/session-review"
import { DataProvider } from "@nexode-ai/ui/context"
import { FileComponentProvider } from "@nexode-ai/ui/context/file"
import { WorkerPoolProvider } from "@nexode-ai/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createEffect, createMemo, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@nexode-ai/ui/logo"
import { IconButton } from "@nexode-ai/ui/icon-button"
import { ProviderIcon } from "@nexode-ai/ui/provider-icon"
import { createDefaultOptions } from "@nexode-ai/ui/pierre"
import { iife } from "@nexode-ai/util/iife"
import { Binary } from "@nexode-ai/util/binary"
import { NamedError } from "@nexode-ai/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import z from "zod"
import NotFound from "../[...404]"
import { Tabs } from "@nexode-ai/ui/tabs"
import { MessageNav } from "@nexode-ai/ui/message-nav"
import { preloadMultiFileDiff, PreloadMultiFileDiffResult } from "@pierre/diffs/ssr"
import { FileSSR } from "@nexode-ai/ui/file-ssr"
import { clientOnly } from "@solidjs/start"
import { Meta, Title } from "@solidjs/meta"
import { Base64 } from "js-base64"

const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@nexode-ai/ui/pierre/worker").then((m) => ({
      ...
      <Show when={data()}>
        {(data) => {
          ...
          const ogImage = createMemo(() => {
            ...
            return `https://social-cards.sst.dev/nexode-share/${encodedTitle}.png?model=${modelParam}&version=${version}&id=${data().shareID}`
          })

          return (
            <>
              <Show when={info().title}>
                <Title>{info().title} | Nexode</Title>
              </Show>
              <Meta name="description" content="nexode - The AI coding agent built for the terminal." />
                        ...
                        <div class="relative bg-background-stronger w-screen h-screen overflow-hidden flex flex-col">
                          <header class="h-12 px-6 py-2 flex items-center justify-between self-stretch bg-background-base border-b border-border-weak-base">
                            ...
                            <div class="flex gap-3 items-center">
                              <IconButton
                                as={"a"}
                                href="https://github.com/iamgrootns/Nexode"
                                target="_blank"
                                icon="github"
                                variant="ghost"
                              />
