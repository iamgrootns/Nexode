...
import { IconNexode } from "./icons/custom"
import { ShareI18nProvider, formatCurrency, formatNumber, normalizeLocale } from "./share/common"
import styles from "./share.module.css"
import type { MessageV2 } from "nexode/session/message-v2"
import type { Message } from "nexode/session/message"
import type { Session } from "nexode/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.nexode_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.nexode_name}>
                    <IconNexode width={16} height={16} />
                  </div>
