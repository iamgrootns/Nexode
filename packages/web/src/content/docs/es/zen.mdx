---
title: Zen
description: Lista seleccionada de modelos proporcionada por Nexode.
---
...
Nexode Zen es una lista de modelos probados y verificados proporcionada por el equipo Nexode.

:::note
Nexode Zen se encuentra actualmente en versión beta.
:::

Zen funciona como cualquier otro proveedor en Nexode. Inicias sesion en Nexode Zen y obtienes
tu API key. Es **completamente opcional** y no necesitas usarlo para usar Nexode.
...
:::tip
Probamos un grupo selecto de modelos y proveedores que funcionan bien con Nexode.
:::
...
Nexode Zen es una puerta de enlace de IA que le brinda acceso a estos modelos.

---

## Cómo funciona

Nexode Zen funciona como cualquier otro proveedor en Nexode.

1. Inicias sesión en **<a href={console}>Nexode Zen</a>**, agregas tu facturación
   detalles y copie su clave API.
2. Ejecuta el comando `/connect` en TUI, selecciona Nexode Zen y pega tu clave API.
...
El [model ID](/docs/config/#models) en tu configuracion de Nexode
usa el formato `nexode/<model-id>`. Por ejemplo, para GPT 5.2 Codex, debes
usar `nexode/gpt-5.2-codex` en tu configuracion.
...
- MiniMax M2.5 Free está disponible en Nexode por tiempo limitado. El equipo está aprovechando este tiempo para recopilar comentarios y mejorar el modelo.
- Big Pickle es un modelo sigiloso gratuito en Nexode por tiempo limitado. El equipo está aprovechando este tiempo para recopilar comentarios y mejorar el modelo.
...
4. **No tener ningún bloqueo** al permitirle usarlo con cualquier otro agente de codificación. Y siempre le permitirá utilizar cualquier otro proveedor con Nexode también.
