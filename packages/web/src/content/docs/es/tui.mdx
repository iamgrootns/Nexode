---
title: TUI
description: Usando la interfaz de usuario del terminal Nexode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Nexode proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar Nexode se inicia TUI para el directorio actual.
...
Cuando utilice Nexode TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a Nexode. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Salga de Nexode. _Alias_: `/quit`, `/q`
...
Esto es independiente de `nexode.json`, que configura el comportamiento del servidor/tiempo de ejecución.
...
Utilice `NEXODE_TUI_CONFIG` para cargar una ruta de configuración de TUI personalizada.
