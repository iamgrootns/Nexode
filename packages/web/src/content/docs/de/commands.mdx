...
Erstellen Sie `.nexode/commands/test.md`:

```md title=".nexode/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die Nexode-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem Nexode [config](/docs/config):

```json title="nexode.jsonc" {4-12}
{
...
- Global: `~/.config/nexode/commands/`
- Pro Projekt: `.nexode/commands/`

```markdown title="~/.config/nexode/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".nexode/commands/component.md"
---
...
```md title=".nexode/commands/create-file.md"
---
...
```md title=".nexode/commands/analyze-coverage.md"
---
...
```md title=".nexode/commands/review-changes.md"
---
...
```md title=".nexode/commands/review-component.md"
---
...
Nexode enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
