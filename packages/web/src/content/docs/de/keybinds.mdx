...
Nexode verfügt über eine Liste von Tastenkombinationen, die Sie über die Nexode-Konfiguration anpassen können.
...
Nexode verwendet für die meisten Keybinds einen `leader`-Schlüssel. Dies vermeidet Konflikte in Ihrem Terminal.
...
Die Eingabeaufforderungseingabe der Nexode-Desktop-App unterstützt gängige Readline/Emacs-style-Verknüpfungen zum Bearbeiten von Text. Diese sind integriert und derzeit nicht über `nexode.json` konfigurierbar.
