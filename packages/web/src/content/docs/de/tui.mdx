---
title: TUI
description: Arbeite mit Nexode in der Terminal-Oberflaeche.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Nexode bietet eine interaktive Terminaloberflaeche (TUI), um mit einem LLM an deinen Projekten zu arbeiten.

Ohne weitere Argumente startet Nexode die TUI im aktuellen Verzeichnis.
...
In der Nexode-TUI kannst du `/` plus Befehlsnamen eingeben, um Aktionen schnell auszufuehren.
Zum Beispiel:
...
Fuegt einen Provider zu Nexode hinzu. Erlaubt die Auswahl aus verfuegbaren Providern und das Hinzufuegen ihrer API-Keys.
...
Beendet Nexode. _Aliase_: `/quit`, `/q`
...
Dies ist getrennt von `nexode.json`, welche das Server-/Runtime-Verhalten konfiguriert.
...
Verwende `NEXODE_TUI_CONFIG`, um einen benutzerdefinierten TUI-Konfigurationspfad zu laden.
