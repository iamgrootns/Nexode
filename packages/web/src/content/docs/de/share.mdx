---
title: Teilen
description: Teile Nexode-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu Nexode-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht Nexode Folgendes:
...
Nexode hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt Nexode den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`nexode.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du nexode in deiner Organisation einsetzt.
