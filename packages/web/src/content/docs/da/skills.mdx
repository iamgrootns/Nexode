...
Agentferdigheter lar Nexode oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går Nexode opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
...
Nexode viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved at bruge mønsterbaserte tillatelser i `nexode.json`:
