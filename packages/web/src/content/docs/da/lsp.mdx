---
title: LSP-servere
description: Nexode integreres med dine LSP-servere.
---

Nexode integreres med Language Server Protocol (LSP) for at hjælpe LLM med at interagere med din kodebase. Den bruger diagnostik til at give feedback til LLM.

---

## Indbyggede

Nexode leveres med flere indbyggede LSP-servere til populære sprog:
...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `NEXODE_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når nexode åbner en fil, vil den:
...
Du kan tilpasse LSP-servere gennem sektionen `lsp` i din nexode-konfiguration.
