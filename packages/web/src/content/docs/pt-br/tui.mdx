---
title: TUI
description: Usando a interface de usuário de terminal nexode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

O nexode fornece uma interface de terminal interativa ou TUI para trabalhar em seus projetos com um LLM.

Executar nexode inicia o TUI para o diretório atual.
...
Ao usar o TUI do nexode, você pode digitar `/` seguido pelo nome de um comando para executar ações rapidamente. Por exemplo:
...
Adicione um provedor ao nexode. Permite que você selecione entre os provedores disponíveis e adicione suas chaves de API.
...
Saia do nexode. _Aliases_: `/quit`, `/q`
...
Isso é separado do `nexode.json`, que configura o comportamento do servidor/runtime.
...
Use `NEXODE_TUI_CONFIG` para carregar um caminho de configuração TUI personalizado.
