...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ Nexode:
...
- ระดับผู้ใช้ (Global): `~/.config/nexode/commands/`
- ระดับโปรเจ็กต์: `.nexode/commands/`
...
Nexode มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
