---
title: TUI
description: استخدام واجهة المستخدم TUI في Nexode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر Nexode واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل Nexode إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة Nexode في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى Nexode. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من Nexode. _الأسماء المستعارة_: `/quit`, `/q`
...
يمكنك تخصيص سلوك واجهة TUI عبر ملف إعدادات Nexode.
...
استخدم `NEXODE_TUI_CONFIG` لتحميل مسار إعدادات TUI مخصص.
