...
description: أنشئ أدوات يمكن لـ LLM استدعاؤها في nexode.
---

الأدوات المخصصة هي دوال تنشئها يمكن لـ LLM استدعاؤها أثناء المحادثات. تعمل جنبا إلى جنب مع [الأدوات المدمجة](/docs/tools) في nexode مثل `read` و`write` و`bash`.
...
- محليا بوضعها في مجلد `.nexode/tools/` داخل مشروعك.
- أو عالميا بوضعها في `~/.config/nexode/tools/`.
