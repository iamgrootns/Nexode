...
يوجد نوعان من الوكلاء في Nexode: وكلاء أساسيون ووكلاء فرعيون.
...
يأتي Nexode مع وكيلين أساسيين مدمجين: **Build** و **Plan**. سنلقي نظرة عليهما أدناه.
...
يأتي Nexode مع وكيلين فرعيين مدمجين: **General** و **Explore**. سنلقي نظرة على ذلك أدناه.

---

## المدمجة

يأتي Nexode مع وكيلين أساسيين مدمجين ووكيلين فرعيين مدمجين.
...
هيّئ الوكلاء في ملف إعدادات `nexode.json`:
...
- عام: `~/.config/nexode/agents/`
- لكل مشروع: `.nexode/agents/`
...
إذا لم يتم تحديد temperature، يستخدم Nexode القيم الافتراضية الخاصة بالنموذج؛ عادة 0 لمعظم النماذج و 0.55 لنماذج Qwen.
...
هذا المسار نسبي لمكان وجود ملف الإعدادات. لذلك يعمل هذا لكل من إعدادات Nexode العامة وإعدادات المشروع.
...
يستخدم معرّف النموذج في إعدادات Nexode الصيغة `provider/model-id`. على سبيل المثال، إذا كنت تستخدم [Nexode Zen](/docs/zen)، فستستخدم `nexode/gpt-5.1-codex` لـ GPT 5.1 Codex.
...
:::tip
شغّل `nexode models` لعرض قائمة بالنماذج المتاحة.
:::
...
:::tip
هل لديك وكيل تود مشاركته؟ [قدّم PR](https://github.com/iamgrootns/Nexode).
:::
