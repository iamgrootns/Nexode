---
title: Zen
description: Lista curata di modelli fornita da Nexode.
---
...
Nexode Zen e una lista di modelli testati e verificati dal team di Nexode.

:::note
Nexode Zen e attualmente in beta.
:::

Zen funziona come qualunque altro provider in Nexode. Accedi a Nexode Zen e ottieni la tua chiave API. E **completamente opzionale**: non devi usarlo per usare Nexode.
...
:::tip
Abbiamo testato un gruppo selezionato di modelli e provider che funzionano bene con Nexode.
:::
...
Nexode Zen e un gateway AI che ti da accesso a questi modelli.

---

## Come funziona

Nexode Zen funziona come qualunque altro provider in Nexode.

1. Accedi a **<a href={console}>Nexode Zen</a>**, aggiungi i dettagli di fatturazione e copia la chiave API.
2. Esegui il comando `/connect` nella TUI, seleziona Nexode Zen e incolla la chiave API.
...
Il [model id](/docs/config/#models) nella config di Nexode usa il formato `nexode/<model-id>`. Per esempio, per GPT 5.2 Codex useresti `nexode/gpt-5.2-codex` nella config.
...
- MiniMax M2.5 Free e disponibile su Nexode per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
- Big Pickle e un modello stealth gratuito su Nexode per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
...
4. Evitare **lock-in** permettendoti di usarlo con qualunque altro agente di coding e lasciandoti sempre usare anche altri provider con Nexode.
