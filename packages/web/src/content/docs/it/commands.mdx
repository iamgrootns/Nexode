...
Puoi aggiungere comandi personalizzati tramite la config di Nexode o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di Nexode:
...
- Globale: `~/.config/nexode/commands/`
- Per progetto: `.nexode/commands/`
...
nexode include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
