---
title: Paylasim
description: nexode konusmalarini genel baglantilarla paylasin.
---

nexode'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda nexode:
...
nexode, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak nexode manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `nexode.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda nexode kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
