---
title: Özel Araçlar
description: LLM'un nexode'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. nexode'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.nexode/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/nexode/tools/` içine yerleştirerek.
