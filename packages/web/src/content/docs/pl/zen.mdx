---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez nexode.
---
...
Nexode Zen to lista przetestowanych i zweryfikowanych modeli udostępniona przez zespół nexode.

:::note
Nexode Zen is currently in beta.
:::

Zen działa jak każdy inny dostawca nexode. Logujesz się do Nexode Zen i dostajesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z nexode.
:::
...
Nexode Zen to brama AI, która zapewnia dostęp do tych modeli.

---

## Jak to działa

Nexode Zen działa jak każdy inny dostawca nexode.

1. Logujesz się do **<a href={console}>Nexode Zen</a>**, dodajesz swoje rozliczenia
   szczegóły i skopiuj klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz Nexode Zen i wklejasz klucz API.
...
[Identyfikator modelu](/docs/config/#models) w konfiguracji nexode
używa formatu `nexode/<model-id>`. Na przykład w przypadku Kodeksu GPT 5.2 zrobiłbyś to
użyj `nexode/gpt-5.2-codex` w swojej konfiguracji.
...
- MiniMax M2.5 Free jest dostępny w Nexode przez ograniczony czas. Zespół wykorzystuje ten czas na zbieranie opinii i ulepszanie modelu.
- Big Pickle to ukryty model, który jest bezpłatny w Nexode przez ograniczony czas. Zespół wykorzystuje ten czas na zbieranie opinii i ulepszanie modelu.
...
4. Nie **nie blokuj**, umożliwiając używanie go z dowolnym innym agentem kodującym. I zawsze pozwalaj na korzystanie z nexode dowolnego innego dostawcy.
