---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala nexode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

nexode zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie nexode uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI nexode, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do nexode. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij nexode. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `nexode.json`, który konfiguruje zachowanie serwera/runtime.
...
Użyj `NEXODE_TUI_CONFIG`, aby załadować niestandardową ścieżkę konfiguracji TUI.
