...
Utwórz `.nexode/commands/test.md`:
...
Możesz zdefiniować polecenia w `nexode.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji nexode:
...
- Globalnie: `~/.config/nexode/commands/`
- Na projekt: `.nexode/commands/`
...
nexode zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
