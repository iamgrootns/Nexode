...
Kreiraj `.nexode/commands/test.md`:
...
Možete dodati prilagođene komande kroz Nexode konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom Nexode [config](/docs/config):
...
- Globalno: `~/.config/nexode/commands/`
- Po projektu: `.nexode/commands/`
...
Nexode uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
