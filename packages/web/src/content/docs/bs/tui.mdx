---
title: TUI
description: Korištenje korisničkog interfejsa Nexode terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Nexode pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje Nexode pokreće TUI za trenutni direktorij.
...
Kada koristite Nexode TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u Nexode. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz Nexode. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `nexode.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
Koristite `NEXODE_TUI_CONFIG` da učitate prilagođenu putanju TUI konfiguracije.
