---
title: Zen
description: Utvalgt liste over modeller levert av Nexode.
---
...
Nexode Zen er en liste over testede og verifiserte modeller levert av Nexode-teamet.

:::note
Nexode Zen er for øyeblikket i beta.
:::

Zen fungerer som alle andre leverandører i Nexode. Du logger på Nexode Zen og får
...
:::tip
Vi testet en utvalgt gruppe modeller og leverandører som fungerer godt med Nexode.
:::
...
Nexode Zen er en AI gateway som gir deg tilgang til disse modellene.

---

## Slik fungerer det

Nexode Zen fungerer som alle andre leverandører i Nexode.

1. Du logger på **<a href={console}>Nexode Zen</a>**, legg til fakturering
   detaljer, og kopier API-nøkkelen.
2. Du kjører kommandoen `/connect` i TUI, velger Nexode Zen og limer inn API-nøkkelen.
...
[modell-id](/docs/config/#models) i Nexode-konfigurasjonen
bruker formatet `nexode/<model-id>`. For eksempel, for GPT 5.2 Codex, ville du
bruk `nexode/gpt-5.2-codex` i konfigurasjonen din.
...
- MiniMax M2.5 Free er tilgjengelig på Nexode i en begrenset periode. Teamet bruker denne tiden til å samle tilbakemeldinger og forbedre modellen.
- Big Pickle er en stealth-modell som er gratis på Nexode i en begrenset periode. Teamet bruker denne tiden til å samle tilbakemeldinger og forbedre modellen.
...
4. Ha **ingen låsing** ved å la deg bruke den med en hvilken som helst annen kodeagent. Og la deg alltid bruke en hvilken som helst annen leverandør med Nexode også.
