...
Opprett `.nexode/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom Nexode-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i Nexode [config](/docs/config):
...
Nexode inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
