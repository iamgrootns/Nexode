---
title: TUI
description: Bruke nexode-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Nexode gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre Nexode starter TUI for gjeldende katalog.
...
Når du bruker Nexode TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til Nexode. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt Nexode. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `nexode.json`, som konfigurerer server-/kjøretidsoppførsel.
...
Bruk `NEXODE_TUI_CONFIG` for å laste en egendefinert TUI-konfigurasjonsbane.
