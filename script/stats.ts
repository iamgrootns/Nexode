...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/iamgrootns/Nexode/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for iamgrootns/Nexode...\n")
...
console.log("Fetching npm all-time downloads for nexode-ai...\n")
const npmDownloads = await fetchNpmDownloads("nexode-ai")
