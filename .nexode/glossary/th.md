...
- PR #10809: https://github.com/iamgrootns/Nexode/pull/10809
- PR #11496: https://github.com/iamgrootns/Nexode/pull/11496

## Do Not Translate (Locale Additions)

- `Nexode` (preserve casing in prose; keep `nexode` only in commands, package names, paths, or code)
- `Nexode CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
