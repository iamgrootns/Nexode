...
- PR #13942: https://github.com/iamgrootns/Nexode/pull/13942

## Do Not Translate (Locale Additions)

- `Nexode` (preserve casing in prose; keep `nexode` only when it is part of commands, package names, paths, or code)
- `Nexode Zen`
- `Nexode CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `nexode` in prose when referring to the product name; use `Nexode`
