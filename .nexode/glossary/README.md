...
Use this folder for locale-specific translation guidance that supplements `.nexode/agent/translator.md`.
...
- PR #12345: https://github.com/iamgrootns/Nexode/pull/12345

## Do Not Translate (Locale Additions)

- `Nexode` (preserve casing)
